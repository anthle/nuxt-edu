...
<template>
  <NForm ref="formRef" class="w-[340px]" :model="formValue" :rules="rules" size="large">
    ...
    <NFormItem ref="rPasswordFormItemRef" first path="reenteredPassword" :show-label="false">
      <NInput v-model:value="formValue.reenteredPassword" :disabled="!formValue.password" show-password-on="click" placeholder="确认密码" type="password" @keydown.enter.prevent />
    </NFormItem>
